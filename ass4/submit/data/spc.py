...
for sent_id, sent_str in [["1", "Israel television rejected a skit by comedian Tuvia Tzafir that attacked public apathy by depicting an Israeli family watching TV while a fire raged outside ."]]:
    sent = nlp(sent_str)
    print("#id:", sent_id)
